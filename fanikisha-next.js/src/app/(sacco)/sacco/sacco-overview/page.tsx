...
//       const eligibleFarmersPerMonth = loanEligibilityData.reduce((acc: { [key: string]: number }, score: CreditScore) => {
//         const month = format(new Date(score.last_checked_date), 'yyyy-MM');
...
//       const sortedEligibleFarmersPerMonth = Object.entries(eligibleFarmersPerMonth)
//         .map(([month, count]) => ({ name: month, value: count }))
//         .sort((a, b) => new Date(a.name).getTime() - new Date(b.name).getTime());

//       console.log('Eligible Farmers per Month:', sortedEligibleFarmersPerMonth);
//       setBarData(sortedEligibleFarmersPerMonth);
//     }
...
//           <div>
//             <h2 className="2xl:text-2xl 2xl:mb-6 lg:text-[15px] xl:text-[20px] lg:mb-7">Eligible Farmers per Month</h2>
//             <div className="bg-white rounded-[34px] 2xl:p-8 lg:px-6 lg:py-4 xl:px-20 xl:py-4 lg:h-[260px] lg:w-[320px] xl:h-[330px] xl:w-[450px] 2xl:w-[720px] 2xl:h-[400px] border-t border-blue-500 shadow-[0_2px_4px_0px_rgba(64,123,255)]">
...
//                 <YAxis domain={[1, 3]} label={{ value: 'Number of Farmers', angle: -90, position: 'insideLeft' }} />
//                 <Tooltip />
              ...
              <div className="w-full h-[300px] 2xl:h-[300px] lg:h-[200px] xl:h-[280px]  2xl:w-full lg:w-[250px] xl:w-[320px] ">
                <ResponsiveContainer width="100%" height="100%">
                  <BarChart data={barData}>
                    ...
                    <YAxis 
                      domain={[0, 'dataMax + 1']} 
                      label={{ value: 'Number of Farmers', angle: -90, position: 'insideLeft' }} 
