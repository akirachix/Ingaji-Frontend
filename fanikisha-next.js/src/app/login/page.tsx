  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      try {
        ...
        // If not, you might need to make an additional API call to fetch the user's role
        const userRole = data.role;
        // Store the user's role in a cookie
        setCookie('userRole', userRole, { maxAge: 30 * 24 * 60 * 60, path: '/' });
        ...
        switch (userRole) {
          ...
          default:
            ...
            setLoginError('Login successful, but unable to determine user role.');
        }
      } catch (err) {
